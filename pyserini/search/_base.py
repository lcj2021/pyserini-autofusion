...
topics_mapping = {
    ...
    'dpr-trivia-train': 'DPR_TRIVIA_TRAIN',
    'dpr-wq-test': 'DPR_WQ_TEST',
    'dpr-wq-train': 'DPR_WQ_TRAIN',
    'dpr-squad-test': 'DPR_SQUAD_TEST',
    'dpr-squad-train': 'DPR_SQUAD_TRAIN',
    'dpr-curated-test': 'DPR_CURATED_TEST',
    'dpr-curated-train': 'DPR_CURATED_TRAIN',
    'dpr-hotpot-train-slim': 'DPR_HOTPOT_TRAIN_SLIM',
    'dpr-hotpot-train': 'DPR_HOTPOT_TRAIN',
    'dpr-hotpot-dev': 'DPR_HOTPOT_DEV',
    'dpr-search-train': 'DPR_SEARCH_TRAIN',
    'dpr-search-train-slim': 'DPR_SEARCH_TRAIN_SLIM',
    'dpr-search-val': 'DPR_SEARCH_VAL',
